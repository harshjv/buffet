> **Heads up** Buffet relies on [js-ipfs](https://github.com/ipfs/js-ipfs) which is currently under development and has a lot of functionalities missing. So some features may not work as expected.
